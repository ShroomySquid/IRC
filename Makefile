...
MY_FILES		=	main.cpp utils.cpp Client.cpp Channel.cpp Commands/cmd_invite.cpp Commands/Cmd_join.cpp Commands/Cmd_kick.cpp Commands/Cmd_privmsg.cpp Server.cpp Commands/pass.cpp Commands/user.cpp Commands/nick.cpp ServerEventLoop.cpp Commands/Cmd_topic.cpp Commands/Cmd_mode.cpp
